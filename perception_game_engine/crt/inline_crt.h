...
inline int _strcmp(const char* cs, const char* ct, bool CaseSensitive = TRUE)
{
    if (cs && ct)
    {
        if (CaseSensitive) {
...
__forceinline int _strcmp_cmplen(const char* cs, const char* ct, bool CaseSensitive = TRUE)
{
...
inline int _wcscmp(const wchar_t* cs, const wchar_t* ct, bool CaseSensitive = true)
{
    if (cs && ct)
    {
        if (CaseSensitive) {
...
inline void* _memcpy(void* dst, const void* src, size_t size) {
    return memcpy(dst, src, size);
}

inline void* _memmove(void* dst, const void* src, size_t size) {
